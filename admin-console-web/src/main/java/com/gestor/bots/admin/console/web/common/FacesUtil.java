...
public class FacesUtil {
	...
	/**
	 * Obtiene la referencia a cualquier tipo de Bean (request, session o application); los beans de scope 'request'
	 * deben estar ejecut�ndose para poder acceder a ellos, en cambio que los Beans de scope 'session' pueden ser
	 * accedidos incluso si aun no han sido cargados en session.
	 *
	...
	/**
	 * Permite crear una expresi�n de valor para asociarlo a los atributos de los componentes de JSF.
	 *
	 * @param expresion EL Expresi�n que representa el valor que se desea asociar.
